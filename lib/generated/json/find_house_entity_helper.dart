...
findHouseEntityFromJson(FindHouseEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
		data.code = json['code'].toString();
	}
	if (json['data'] != null) {
		data.data = new List<FindHouseData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new FindHouseData().fromJson(v));
		});
	}
	if (json['msg'] != null) {
...
Map<String, dynamic> findHouseEntityToJson(FindHouseEntity entity) {
...
findHouseDataFromJson(FindHouseData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> findHouseDataToJson(FindHouseData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
